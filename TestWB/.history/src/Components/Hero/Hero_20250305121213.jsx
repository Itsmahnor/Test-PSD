...
// import '@fancyapps/ui/dist/css/fancybox.css';
    ...
    <div className="relative">
      <Slider {...settings}>
        {slides.map((slide) => (
          <div
            key={slide.id}
            className="relative w-[100vw] bg-green-950 h-[70vh] flex flex-col"
            style={{
          ...
          >
            ...
            {/* Content */}
            <div className="relative  flex flex-col md:flex-row items-center justify-between px-8 lg:px-36 py-12 w-full h-full">
              {/* Left Side: Text */}
